...
- Test suite is structured in a format that is more common to frameworks like Mocha & Jasmine (setup, teardown, etc.), which is not strictly speakding "idiomatic" but makes for a much easier time in terms of maintenance & enhancement
